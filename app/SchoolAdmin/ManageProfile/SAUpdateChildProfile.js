...
const SAUpdateChildProfile = () => {
  ...
  const updateProfile = async () => {
    ...
    try {
      const apiData = await API.put('api55db091d', '/child/updateprofile', data);
      console.log(apiData);
    } catch (error) {
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      ...
      <Text style={{fontSize: 30,fontWeight: "bold",textAlign:"center"}}>School Admin Update Child Profile</Text>
        ...
        <View style={styles.inputContainer}>
          <Text style={styles.label}>GuardianID:</Text>
          <TextInput
            style={styles.textInput}
            value={guardianID}
            editable={true}
...
export default SAUpdateChildProfile;