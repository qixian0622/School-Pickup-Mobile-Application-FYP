...
const ChildUpdatePassword = () => {
  ...
  const updatepassword = async (currentpassword, newpassword, confirmpassword) => {
    ...
    try {
      ...
      Alert.alert('Update Successful', 'Password has been updated successfully.', [
        {
          text: 'OK',
          onPress: () => navigation.navigate('ChildProfile'), // Navigate to profile page after user clicks 'OK'
        },
      ]);
    } catch (err) {
      const errorMessage =
  ...
  return (
    <BackgroundColor>
      ...
      <Text style={{fontSize: 30,fontWeight: "bold",textAlign:"center",marginTop: 20}}>Child Update Password</Text>
